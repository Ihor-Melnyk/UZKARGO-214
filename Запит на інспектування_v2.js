...
function setPropRegistration() {
  ...
  if (stateTaskSendOutDoc == "inProgress" || stateTaskSendOutDoc == "delegated" || stateTaskSendOutDoc == "completed" || stateTaskApproveRequest == "inProgress" || stateTaskApproveRequest == "delegated" || stateTaskApproveRequest == "completed") {
...
function onTaskPickUpedSendOutDoc() {
  setPropRegistration();
}

function onTaskPickUpedApproveRequest() {
  setPropRegistration();
}